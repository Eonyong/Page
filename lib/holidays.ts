// 대한민국 공휴일 (대체공휴일 포함). 연도별 표 — 다음 해가 필요하면 아래에 추가.
// 출처: 관공서의 공휴일에 관한 규정, 음력 명절은 해당 연도 달력 기준.
...
export function holidayName(ymd: string): string | undefined { return HOLIDAYS[ymd]; }
